...
const pt: Record<string, string> = {
  ...
  'Explore new looks.': 'Explore novos visuais.',
  ...
  'Continue working with your clients and their looks.': 'Continue acompanhando seus clientes e seus visuais.',
  ...
  'Create a client to begin exploring looks.': 'Crie um cliente para começar a explorar visuais.',
  '← All clients': '← Todos os clientes',
  'CLIENT WORKSPACE': 'ESPAÇO DO CLIENTE',
  'A private space to explore this client’s looks.': 'Um espaço privado para explorar os visuais deste cliente.',
